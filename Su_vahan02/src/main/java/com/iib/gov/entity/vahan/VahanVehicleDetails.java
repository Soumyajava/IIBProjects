package com.iib.gov.entity.vahan;
...
public class VahanVehicleDetails implements Serializable {
	...
	@Column(name = "IIB_Manufacturer_Code")
	...
	@JsonProperty("IIB_Manufacturer_of_the_Vehicle")
	@Column(name = "IIB_Manufacturer_of_the_Vehicle")
	private String iibmanufactureofvehicle;
	
	@JsonProperty("IIB_Model_Code")
	@Column(name = "IIB_Model_Code")
	private String iibmodelcode;
	
	
	@JsonProperty("IIB_Model_of_the_Vehicle")
	@Column(name = "IIB_Model_of_the_Vehicle")
